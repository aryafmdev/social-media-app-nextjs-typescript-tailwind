...
export default function AlertBanner({ label, variant, onClose }: Props) {
  ...
  return (
    <div className="border border-dashed border-primary-300 rounded-[5px] p-[16px] w-full">
      <div className={`flex items-center justify-center gap-[8px] px-[12px] py-[8px] w-full h-[40px] ${bg} rounded-[8px] relative`}>
